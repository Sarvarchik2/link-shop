      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            ...
            <input v-model="form.image_url" required class="input" />
          </div>
...
watch(product, (newProduct) => {
  if (newProduct) {
    ...
    // Parse sizes
    try {
      selectedSizes.value = newProduct.sizes ? JSON.parse(newProduct.sizes) : []
    } catch {
      selectedSizes.value = []
    }
    ...
    // Parse images
    try {
      const images = newProduct.images ? JSON.parse(newProduct.images) : []
      if (images.length > 1) {
...
const handleSubmit = async () => {
  try {
    ...
    const imagesArray = [form.value.image_url]
